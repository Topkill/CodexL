...
详细文档地址：[https://codexl.io/docs](https://codexl.io/docs)。
...
CodexL 让你为不同客户、项目、模型和网络链路准备不同的 Codex 环境。切换上下文时不必重新搭配置，每个 workspace 都能保持清爽、独立、可长期使用。

## 手机远控，随时跟进

在桌面端启动 Codex 任务，然后用手机持续跟进。CodexL 让长任务观察、临时检查和离开电脑后的轻量操作更自然。

## 内置网关扩展

CodexL 内置面向连接能力的网关扩展，让 Codex 更容易接入 IM 平台、灵活供应商工作流和自定义 AI 路由场景，减少重复搭桥和手动集成的成本。

## 适合谁使用

- 同时运行多个 Codex 项目的开发者。
- 需要频繁切换 provider、代理和 workspace 配置的使用者。
- 希望把 Codex 工作流延伸到桌面、手机和网关集成场景的团队。
